...
def open_lwindow():
        ...
        # Added as comments: 10 Nov
        #lwindow = LearnWindow(video_source='example.avi')
        #lwindow.grab_set()

        detect.detect(imgsz=[500, 500], save_conf=True, save_txt=True, source='0', weights=['/home/hpc/FYPdental/Yolo/yolov5/runs/train/exp4/weights/last.pt'])
